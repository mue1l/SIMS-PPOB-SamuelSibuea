...
export default function Pembayaran() {
  ...
  <p className="text-gray-700 mt-6">pemBayaran</p>
  <div></div>
  <p className="font-bold text-gray-900 mt-2">Listrik prabayar</p>
  <div className="grid mt-4">
    <div className="col-span-3 flex flex-col space-y-4">
      <form className="flex flex-col space-y-4">
        ...
        <button
          type="submit"
          className="bg-red-500 text-white rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-red-500 w-full"
        >
          Bayar
        </button>
      </form>
